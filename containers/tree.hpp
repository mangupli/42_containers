...
/*   Updated: 2022/08/08 14:27:35 by mspyke           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	void		erase(iterator position){
		...
		if (replace != to_delete) { // make the link to the node replace be in place of to_delete back
